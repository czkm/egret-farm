window.skins={};
	...
	function farm_land() {
		_super.call(this);
		this.skinParts = ["cai_anim","take","farm_land_area","farm_land_normal","farm_land_cai","farm_sc_tip","farm_sc_name","farm_sc_take","farm_sc_area","farm_is_tip","farm_null_tip","farm_tip_manage"];
		
		this.height = 268;
		this.width = 340;
		this.cai_anim_i();
		this.take_i();
		this.elementsContent = [this.farm_land_area_i(),this.farm_land_normal_i(),this.farm_land_cai_i(),this.farm_tip_manage_i()];
